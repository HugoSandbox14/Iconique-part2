...
parcellation = 'aparc'                                  # type de parcellation : 'aparc' = Desikan Killiany

# pour nettoyage des epoch/channel
std_bad_epoch = 2.5    # --> mean + 'std_bad_epoch' x std   | permet de definir le seuil d'exclusion d'une epoch par rapport au temps de latence entre stimulation et reponse 
